...
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
nReteszNum = 6;         /* Reteszes TMOK-k száma */


dpPars[0].nSite   = 3;       /* G front end */
dpPars[0].nDP_ID  = 1250;    /* DP6, 0. */

dpPars[1].nSite   = 2;       /* E front end */
dpPars[1].nDP_ID  = 1254;    /* DP6, 0. */
...
dpPars[4].nSite   = 3;       /* B: 10-24-> G front end */
dpPars[4].nDP_ID  = 1300;    /* DP6, 50. */

dpPars[5].nSite   = 3;       /* H: Kisbér Iskola u. -> G front end */
dpPars[5].nDP_ID  = 1301;    /* DP6, 50. */
