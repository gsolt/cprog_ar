...
ST[0].nSiteList[0]=3;   		ST[0].nLinkList[0]=RSLINK3;	/* Front end A							*/
ST[0].nSiteList[1]=5000; 	  	ST[0].nLinkList[1]=RSLINK3;	/* Front end C							*/
ST[0].nSiteList[2]=7000;	  	ST[0].nLinkList[2]=RSLINK3;	/* Front end E							*/
ST[0].nSiteList[3]=9000; 		ST[0].nLinkList[3]=RSLINK3;	/* Front end G						*/
